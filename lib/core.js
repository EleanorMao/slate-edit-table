...
function core(optionsParam: Options | OptionsFormat): Object {
    ...
    return {
        ...
        utils: {
            ...
            getTableInfo: getTableInfo.bind(null, opts),
            getCellsByCellIndex: getCellsByCellIndex.bind(null, opts),
            getCell: getCell.bind(null, opts),
            couldCellMergeDown: couldCellMergeDown.bind(null, opts),
            couldCellMergeRight: couldCellMergeRight.bind(null, opts)
        },
        ...
        changes: {
            ...
            mergeDown: bindAndScopeChange(opts, mergeDown),
            mergeRight: bindAndScopeChange(opts, mergeRight),
            splitToRows: bindAndScopeChange(opts, splitToRows),
            splitToCols: bindAndScopeChange(opts, splitToCols),
            splitToCells: bindAndScopeChange(opts, splitToCells)
        }
    };
}
